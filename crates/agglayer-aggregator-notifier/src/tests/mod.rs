...
//             &self,
//         ) -> Result<Vec<agglayer_types::NetworkId>,
// agglayer_storage::error::Error> {             todo!()
//         }
//
...
//         ) -> Result<Option<agglayer_types::CertificateHeader>,
...
//             _network_id: agglayer_types::NetworkId,
//             _height: agglayer_types::Height,
//         ) -> Result<Option<agglayer_types::Certificate>,
// agglayer_storage::error::Error> {             todo!()
//         }
//
...
//         ) -> Result<Vec<Option<agglayer_types::Certificate>>,
// agglayer_storage::error::Error>         {
//             todo!()
//         }
//
...
//         ) -> Result<Vec<Option<agglayer_types::Proof>>,
// agglayer_storage::error::Error> {             todo!()
//         }
//
//         fn get_proof(
...
//         ) -> Result<Option<agglayer_types::Proof>,
// agglayer_storage::error::Error> {             todo!()
//         }
//     }
...
//     async fn aggregator_notifier_can_be_implemented(#[case] config:
// ProverConfig) {         use std::sync::Arc;
//
