...
// impl<I, StateStore, EpochsStore> AggregatorNotifier<I, StateStore,
// EpochsStore> where
//     I: Serialize,
// {
//     /// Try to create a new notifier using the given configuration
...
// }
//
// impl<I, StateStore, EpochsStore> EpochPacker for AggregatorNotifier<I,
// StateStore, EpochsStore> where
