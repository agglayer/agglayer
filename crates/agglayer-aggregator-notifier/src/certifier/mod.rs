...
use agglayer_types::{
    ...
    bincode, Address, Certificate, Digest, Height, L1WitnessCtx, LocalNetworkStateData, NetworkId,
    PessimisticRootInput, Proof, B256,
};
use pessimistic_proof::{
    core::{
        commitment::{SignatureCommitmentValues, SignatureCommitmentVersion, StateCommitment},
