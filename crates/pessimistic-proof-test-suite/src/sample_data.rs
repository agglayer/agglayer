...
use hex_literal::hex;
use pessimistic_proof::{address, U256};
...
fn sample_exit_tree_01() -> LocalExitTree {
    ...
    LocalExitTree::from_parts(
        ...
        [
            Digest(hex!(
                "4a3c0e05a537700590e5cfa29654e7db5b36fbe85b24e7f34bdec7ed2b194aa6"
            )),
            Digest(hex!(
                "167e9d479ed70cdd2918875dd368edacc1b900085a2db71832a951ac7df31e10"
            )),
            Digest(hex!(
                "480549a7a72ab13cb9dd7a1c48f3b2749be3f3a7dd440f16125a1aa5cbf07991"
            )),
            Digest(hex!(
                "81b8a2cf7a80538dee49ae721a87655b080523d37cdad80c6a002a33e91c96cb"
            )),
            Digest(hex!(
                "5003a15ab43bbf7e8a86fe84c7af7a515e8086e53308b4321ac83560e44cd17b"
            )),
            Digest(hex!(
                "02c16029dec2ad77fb3f45ade9b12be2a191dc5bde71e15c5e873695b06eebb2"
            )),
            Digest(hex!(
                "9779f2ddec81f886c42d4813cd3fe44a8e5d077df11dab2d96d8e52e575ad196"
            )),
            Digest(hex!(
                "ff709923054a0745097aa2bd8b74f3434c2ef34ba4245af36efbb7792c719012"
            )),
            Digest(hex!(
                "47ea61b79f448e3d692755fdd7ea1242148f1736e2ec44910ed34397f093364d"
            )),
            Digest(hex!(
                "96f8e65b2aaa2500a40c5f8e72886cbe47248bda77d76d89666e47509649fdba"
            )),
            Digest(hex!(
                "50f7e8cc2d5e5e9f6ce5e5d0352fff94f6569449620e6e6a693b3dfb9d44e683"
            )),
            Digest(hex!(
