...
pub mod certificate_submission_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct CertificateSubmissionServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl CertificateSubmissionServiceClient<tonic::transport::Channel> {
    ...
    impl<T> CertificateSubmissionServiceClient<T>
    where
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> CertificateSubmissionServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            CertificateSubmissionServiceClient::new(
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "agglayer.node.v1.CertificateSubmissionService",
                        "SubmitCertificate",
                    ),
                );
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "agglayer.node.v1.ConfigurationService",
