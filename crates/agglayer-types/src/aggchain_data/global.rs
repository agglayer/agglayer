...
//!
//! 1. current generic, receive one aggchain proof with trusted sequencer
//!    signature verified only on the agglayer
//!   - stark proof
//!   - single ecdsa verified on the agglayer (+ optional pv for debug)
//!   - aggchain params
//!
//! 2. generic + multisig (one or the other, or both)
...
pub enum AggchainDataError {
    ...
    #[error("Legacy ECDSA aggchain data is no longer supported")]
    LegacyEcdsaUnsupported,
}
