        ...
        match self {
            ...
            AggchainHashValues::ConsensusType1 {
                ...
                let aggchain_vkey_hash = {
                    let vkey = aggchain_vkey.unwrap_or_else(AggchainData::empty_sp1_vkey);
                ...
                let aggchain_params =
                    aggchain_params.unwrap_or_else(AggchainData::empty_aggchain_params);
                let signers = signers_commit.unwrap_or_else(AggchainData::empty_signers);
                let threshold = threshold.unwrap_or_else(AggchainData::empty_threshold);
