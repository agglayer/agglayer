...
use crate::{
    ...
    local_state::{commitment::StateCommitment, NetworkState},
...
pub fn generate_pessimistic_proof(
    ...
    let new_pessimistic_root = {
        ...
        StateCommitment::compare(&batch_header.target, &computed_target)?;

        computed_target.compute_pp_root(target_pp_root_version)
    };
