...
| Crate                                                                          | Description                                                                                                                                                                                                                                                                                                                                                        |
| ---                                                                            | ---                                                                                                                                                                                                                                                                                                                                                                |
| [agglayer-aggregator-notifier](/crates/agglayer-aggregator-notifier)           | Contains implementations for [Certifier](crates/agglayer-certificate-orchestrator/src/certifier.rs#L29) which applies new [Certificate](crates/agglayer-types/src/lib.rs#245) on top of an existing state and computes the proof, as well as [SettlementClient](crates/agglayer-certificate-orchestrator/src/settlement_client.rs#L30), which handles the packing of an epoch |
